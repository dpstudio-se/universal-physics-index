...
from .models import Address, Bridge, PhysicsNode, EdgeType
...
class UPIGraph:
    ...
    def get_node(self, address: Address) -> Optional[PhysicsNode]:
    ...
    def get_related_nodes(self, address: Address, edge_type: Optional[EdgeType] = None) -> List[PhysicsNode]:
